...
const { createItinerary, getSoloItineraries, getColabItineraries, updateItinerary, addPlaceToItinerary, addUserToItinerary, deleteUser, deletePlace, getColabUsers, deleteItinerary } = require("../controller/itineraryController");
