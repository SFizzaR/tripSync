    ...
    <section>
      ...
      <AnimatePresence>
        {expanded && (
          ...
          >
            {[
              { name: "Zahab Jahangir", role: "BACKEND DEVELOPER", img: zaibo, link: "https://www.linkedin.com/in/zahab-jahangir-11971623b/" },
              { name: "Syeda Fizza", role: "BACKEND DEVELOPER", img: fizzy, link: "https://www.linkedin.com/in/syeda-fizza-2b66001b5/" },
              { name: "Zehra Waqar", role: "FRONTEND DEVELOPER", img: zehra, link: "https://www.linkedin.com/in/zehra-waqar-4a553124b/" }
            ].map((creator, index) => (
